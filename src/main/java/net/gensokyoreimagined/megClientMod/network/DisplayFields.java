...
public final class DisplayFields {
    ...
    // 1.21.11+ retypes the VECTOR3/QUATERNION serializers to read-only Vector3fc/Quaternionfc.
    //? if >=1.21.11 {
    public static SynchedEntityData.DataValue<org.joml.Vector3fc> translation(Vector3f value) {
        return new SynchedEntityData.DataValue<>(TRANSLATION_ID, EntityDataSerializers.VECTOR3, value);
    }

    public static SynchedEntityData.DataValue<org.joml.Vector3fc> scale(Vector3f value) {
        return new SynchedEntityData.DataValue<>(SCALE_ID, EntityDataSerializers.VECTOR3, value);
    }

    public static SynchedEntityData.DataValue<org.joml.Quaternionfc> leftRotation(Quaternionf value) {
        return new SynchedEntityData.DataValue<>(LEFT_ROTATION_ID, EntityDataSerializers.QUATERNION, value);
    }

    public static SynchedEntityData.DataValue<org.joml.Quaternionfc> rightRotation(Quaternionf value) {
